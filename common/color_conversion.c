...
inline __attribute__((__always_inline__)) static void bgr_to_ycbcr(const bgr_pixel_t *src, ycbcr_pixel_t *dst)
{
...
inline __attribute__((__always_inline__)) static void ycbcr_to_bgr(const ycbcr_pixel_t *src, bgr_pixel_t *dst)
{
